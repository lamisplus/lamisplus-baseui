...
const ModalViewResult = (props) => {
  ...
  return (      
      <div >
            ...
            <ModalHeader toggle={props.togglestatus}>Samples Dispatched </ModalHeader>
                <ModalBody>
                            ...
                            <CardBody>
                                <Row >
                                    ...
                                    <Col md={6}>
                                      ...
                                      <Col md={6}>
                                                <FormGroup>
                                                    <Label for="middleName">Courier Name</Label>
                                                        <Input
                                                            type="text"
                                                            name="courier_name"
                                                            id="courier_name"
                                            ...
                                            <Col md={6}>
                                                <FormGroup>
                                                    <Label for="middleName">Courier Phone Number</Label>
                                                        <Input
                                                            type="text"
                                            ...
                                            <Col md={6}>
                                                <FormGroup>
                                                    <Label for="middleName">Packaged By</Label>
                                                        <Input
                                                            type="text"
                                                            name="packaged_by"
                                                            id="packaged_by"
                                            ...
                                            <Col md={6}>
                                                <FormGroup>
                                                    <Label for="middleName">Packaged Person Phone Number</Label>
                                                        <Input
                                                            type="text"
