...
import * as checkInActions from "../../store/actions/checkIn/checkIn";
...
const columns = (modalClickHandler => [
    ...
    },
    {
        ...
        cell: row =>
            <div>
                <IconButton color="primary" onClick={() => modalClickHandler(row)} aria-label="CheckIn Patient" title="Check In Patient">
...
const CheckiInListTable = (props) => {
    ...
    useEffect(() => {
     ...
     const validate = (fieldValues = values) => {
        ...
        if ('dateVisitStart' in fieldValues)
            temp.dateVisitStart = fieldValues.dateVisitStart ? "" : "This field is required."
        if ('timeVisitStart' in fieldValues)
            temp.timeVisitStart = fieldValues.timeVisitStart ? "" : "This field is required."
        setErrors({
            ...temp
        })
    ...
    return (
     ...
     {errorMsg}
                    ...
                    <Row form>
                        ...
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <DateTimePicker time={false} id="visitDate" name="visitDate" value={values.visitDate}   onChange={value1 => setValues({...values, visitDate: value1})}
                ...
                <ModalFooter>
                    <Button color="primary" onClick={handleSubmit}>CheckIn</Button>{' '}
